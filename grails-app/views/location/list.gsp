			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="displayName" title="${message(code: 'location.name.label', default: 'Name')}" />
					
						<th><g:message code="location.parentLocation.label" default="Parent Location" /></th>
				...
				<g:each in="${locationInstanceList}" status="i" var="locationInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${locationInstance.id}">${fieldValue(bean: locationInstance, field: "displayName")}</g:link></td>
					
						<td>${fieldValue(bean: locationInstance, field: "parentLocation")}</td>
